...
- `McpServerCreateResponse = StdioMcpServer | SseMcpServer | StreamableHTTPMcpServer`
...
`client.mcpServers.tools.retrieve(stringtoolID, ToolRetrieveParamsparams, RequestOptionsoptions?): Tool`
...
const tool = await client.mcpServers.tools.retrieve('tool_id', { mcp_server_id: 'mcp_server_id' });
...
const toolExecutionResult = await client.mcpServers.tools.run('tool_id', {
