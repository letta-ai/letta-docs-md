...
`client.blocks.update(stringblockID, BlockUpdateParamsbody, RequestOptionsoptions?): BlockResponse`
...
const blockResponse = await client.blocks.update('block-123e4567-e89b-42d3-8456-426614174000');
...
`client.blocks.retrieve(stringblockID, RequestOptionsoptions?): BlockResponse`
...
const blockResponse = await client.blocks.retrieve('block-123e4567-e89b-42d3-8456-426614174000');
...
`client.blocks.agents.list(stringblockID, AgentListParamsquery?, RequestOptionsoptions?): ArrayPage<AgentState>`
...
// Automatically fetches more pages as needed.
for await (const agentState of client.blocks.agents.list(
