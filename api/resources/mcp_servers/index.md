...
### Update Streamable HTTP Mcp Server
...
- `McpServerCreateResponse = StdioMcpServer or SseMcpServer or StreamableHTTPMcpServer`
...
- `McpServerListResponse = array of StdioMcpServer or SseMcpServer or StreamableHTTPMcpServer`
...
### Mcp Server Retrieve Response

- `McpServerRetrieveResponse = StdioMcpServer or SseMcpServer or StreamableHTTPMcpServer`
...
### Mcp Server Update Response

- `McpServerUpdateResponse = StdioMcpServer or SseMcpServer or StreamableHTTPMcpServer`
...
```http
curl https://api.letta.com/v1/mcp-servers/$MCP_SERVER_ID/tools/$TOOL_ID \
    -H "Authorization: Bearer $LETTA_API_KEY"
```
...
```http
curl https://api.letta.com/v1/mcp-servers/$MCP_SERVER_ID/tools/$TOOL_ID/run \
    -X POST \
    -H "Authorization: Bearer $LETTA_API_KEY"
```
...
- `ToolListResponse = array of Tool`
