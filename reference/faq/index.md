...
We recommend using [chat.letta.com](https://chat.letta.com) on your mobile device; it is fully mobile-compatible. You can also build a mobile app with the [Letta Agent SDK’s browser and React Native client](/agent-sdk/quickstart#browser-and-react-native/index.md).
